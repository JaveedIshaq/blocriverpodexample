...
import 'package:blocriverpodexample/presentation/state/network/network_cubit.dart';
import 'package:blocriverpodexample/presentation/state/state_notifier/fact_notifier.dart';
...
class FactsPage extends ConsumerStatefulWidget {
  ...
  @override
  FactsState createState() => FactsState();
}

class FactsState extends ConsumerState<FactsPage> {
  @override
...
class LoadFactButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ElevatedButton(
          onPressed: onPressed, //isConnected ? onPressed : null,
